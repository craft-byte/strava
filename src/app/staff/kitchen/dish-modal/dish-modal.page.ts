...
export class DishModalPage implements OnInit, OnDestroy {
    ...
    async done() {
        const result: any = await this.service.delete("cook", "order", this.orderId, "dish", this.orderDishId, "done");
    ...
    async quit() {
        const result: any = await this.service.delete("cook", "order", this.orderId, "dish", this.orderDishId, "quit");
    ...
    async take() {
        try {
            const result: any = await this.service.post({}, "cook", "order", this.orderId, "dish", this.orderDishId, "take");
    ...
    async ngOnInit() {
        try {
            const result: Response = await this.service.get("cook", "order", this.orderId, "dish", this.orderDishId, "info");
