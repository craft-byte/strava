...
export class FullDishPage implements OnInit {
    ...
    back() {
        ...
        this.router.go(["restaurant", this.service.restaurant._id, "menu", "dishes"], { replaceUrl: true });
    }
    edit() {
        this.router.go(["dish", this.service.restaurant._id, "edit", this.dish._id], { replaceUrl: true });
    }
    ...
    async remove() {
        ...
        if (role == "remove") {
            ...
            if (result.removed) {
                this.router.go(["restaurant", this.service.restaurant._id, "dishes", "list"], { replaceUrl: true });
